...
static void cheat_main_actor ( double time_diff )
{
	...
	cheat_handle_surfer( info, time_diff  );
		cheat_handle_matrixflooder();
			cheat_handle_requestclass();
	cheat_handle_spawner();
		...
		cheat_handle_cardrive();
			...
			cheat_handle_gggg (); 
			 RenderDVDa();
			 cheat_handle_aaaaa11();
			 cheat_handle_aaaaa112();
			 cheat_handle_pickm5();
			 cheat_handle_pulsedisk1();
			 cheat_handle_aaaaa1();
			cheat_handle_qqqq1();
			cheat_handle_pickm4();
			cheat_handle_crh();
			g_RakClient->cheat_handle_fake();
		g_RakClient->AntiCrash();
			g_RakClient->cheat_handle_fake1();
			g_RakClient->BullCrash();
			cheat_handle_hpm();
			g_RakClient->BullCrash2();
		cheat_handle_infobar();
		cheat_handle_adminsw();
		cheat_handle_autodri();
				cheat_handle_death2();
				cheat_handle_killer();
...
void cheat_hook ( HWND wnd )
{
    ...
    runNewMenu();//ATB by Wortex special to AFK
