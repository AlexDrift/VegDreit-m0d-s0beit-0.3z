...
hk_PlCol_process:
	...
	if ( cheat_state->_generic.nocols_enabled )
	{
		...
		if ( !isBadPtr_GTA_pPed((actor_info *)PlayerCollision_esi_back) &&
			...
			goto hk_PlCol_noCol;
		/////////////////////////////////////////////////////////////////
		if ( !((object_info *)PlayerCollision_edi_back) &&
			(!((object_info *)PlayerCollision_esi_back) ||
			!((object_info *)PlayerCollision_esi_back) ) )
			goto hk_PlCol_noCol;

		// Player (esi) -> Player (edi)
		if ( !((object_info *)PlayerCollision_esi_back) &&
			!((object_info *)PlayerCollision_edi_back) )
			goto hk_PlCol_noCol;
	}
