...
static void ini_init ( void )
{
	...
	if ( (ent = ini_register_entry("fps_limit", TYPE_INT)) != NULL )
		...
		if ( (ent = ini_register_entry("player", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.player, "0" );
		 if ( (ent = ini_register_entry("populator_time", TYPE_INT)) != NULL )
...
ini_register_data( ent, set.admin + i, "" ); 
	...
	/* air brake *///ATB by Wortex special to AFK
	...
	*/
	...
	if ( (ent = ini_register_entry("speedometer_old_enable", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.speedometer_old_enable, "true" );
	...
	///////////////////////////////////////////////////////////////////////////////////////
	if ( (ent = ini_register_entry("speedometer_needle_png_filename1", TYPE_STRING)) != NULL )
		ini_register_data( ent, set.speedometer_needle_png_filename1, "speedo.png" );

	if ( (ent = ini_register_entry("speedometer_multiplier1", TYPE_FLOAT)) != NULL )
		ini_register_data( ent, &set.speedometer_multiplier1, "170.00" );
	//////////////////////////////////////////////////////////////////////////////////////////
