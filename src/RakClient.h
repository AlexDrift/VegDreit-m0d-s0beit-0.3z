...
public:
	...
	virtual BYTE GetPacketID( Packet* ReceivedPacket );
	...
	virtual	void SendFakeOnfootSyncData(float fPos[3], float speed[3]);
...
public:
	...
	//void  RakClient::DamageVehicle( USHORT VehicleID, bool panelst, bool doorst, bool lightst, bool tirest );
